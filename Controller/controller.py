...
from XAI.ExplainabilityModels import ExplainabilityModels
from Model.Models import IFModel, BenchmarkModels
from Model.get_param_grid import get_param_grid_for_model
...
class AnomalyController:
    ...
    def load_dataset(self, file_path):
        ...
        self.X, self.y, self.dataset = DataLayer.DataLoader.load_data(file_path)
        return self.dataset.head(10)

    def load_synthetic_data(self, choice):
        """Sentetik veri oluşturur (moons, spiral, blobs, vs.)"""
        self.X, self.y = DataLayer.DataLoader.create_SyntheticData(choice)
        self.dataset = None
    ...
    def run_if_model(self, model_type, score_method, params):
        ...
        model_data = get_param_grid_for_model(model_type)
